...
class WPAM_Admin {
	...
	public function register_settings() {
		...
		add_settings_field( 'wpam_enable_twilio', __( 'Enable Twilio Notifications', 'wpam' ), array( $this, 'field_enable_twilio' ), 'wpam_settings', 'wpam_providers' );

		add_settings_field( 'wpam_enable_email', __( 'Enable Email Notifications', 'wpam' ), array( $this, 'field_enable_email' ), 'wpam_settings', 'wpam_providers' );

		add_settings_field( 'wpam_enable_firebase', __( 'Enable Firebase', 'wpam' ), array( $this, 'field_enable_firebase' ), 'wpam_settings', 'wpam_providers' );

		add_settings_field( 'wpam_firebase_server_key', __( 'Firebase Server Key', 'wpam' ), array( $this, 'field_firebase_server_key' ), 'wpam_settings', 'wpam_firebase' );

		add_settings_field( 'wpam_twilio_sid', __( 'Twilio SID', 'wpam' ), array( $this, 'field_twilio_sid' ), 'wpam_settings', 'wpam_twilio' );

		add_settings_field( 'wpam_twilio_token', __( 'Twilio Token', 'wpam' ), array( $this, 'field_twilio_token' ), 'wpam_settings', 'wpam_twilio' );

		add_settings_field( 'wpam_twilio_from', __( 'Twilio From Number', 'wpam' ), array( $this, 'field_twilio_from' ), 'wpam_settings', 'wpam_twilio' );

		add_settings_field( 'wpam_lead_sms_alerts', __( 'Enable Bid SMS Alerts', 'wpam' ), array( $this, 'field_lead_sms_alerts' ), 'wpam_settings', 'wpam_twilio' );

		add_settings_field( 'wpam_sendgrid_key', __( 'SendGrid API Key', 'wpam' ), array( $this, 'field_sendgrid_key' ), 'wpam_settings', 'wpam_providers' );

		add_settings_field( 'wpam_require_kyc', __( 'Require KYC Verification', 'wpam' ), array( $this, 'field_require_kyc' ), 'wpam_settings', 'wpam_general' );

		add_settings_field( 'wpam_realtime_provider', __( 'Realtime Provider', 'wpam' ), array( $this, 'field_realtime_provider' ), 'wpam_settings', 'wpam_realtime' );

		add_settings_field( 'wpam_pusher_app_id', __( 'Pusher App ID', 'wpam' ), array( $this, 'field_pusher_app_id' ), 'wpam_settings', 'wpam_realtime' );

		add_settings_field( 'wpam_pusher_key', __( 'Pusher Key', 'wpam' ), array( $this, 'field_pusher_key' ), 'wpam_settings', 'wpam_realtime' );

		add_settings_field( 'wpam_pusher_secret', __( 'Pusher Secret', 'wpam' ), array( $this, 'field_pusher_secret' ), 'wpam_settings', 'wpam_realtime' );
