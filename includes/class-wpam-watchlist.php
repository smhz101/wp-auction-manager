...
class WPAM_Watchlist {
	public function __construct() {
		add_action( 'wp_ajax_wpam_toggle_watchlist', array( self::class, 'toggle_watchlist' ) );
		add_action( 'wp_ajax_nopriv_wpam_toggle_watchlist', array( self::class, 'toggle_watchlist' ) );

		add_action( 'wp_ajax_wpam_get_watchlist', array( self::class, 'get_watchlist' ) );

		add_filter( 'woocommerce_account_menu_items', array( $this, 'add_account_menu_item' ) );
		add_action( 'woocommerce_account_watchlist_endpoint', array( $this, 'render_account_page' ) );
	}
	...
	public static function toggle_watchlist() {
		...
		if ( $existing ) {
			...
			wp_send_json_success( array( 'message' => __( 'Removed from watchlist', 'wpam' ) ) );
		} else {
			$wpdb->insert(
				$table,
				array(
			...
			wp_send_json_success( array( 'message' => __( 'Added to watchlist', 'wpam' ) ) );
		}
	}
