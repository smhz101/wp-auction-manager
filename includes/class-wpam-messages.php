...
class WPAM_Messages {
	public function __construct() {
		add_action( 'wp_ajax_wpam_submit_question', array( $this, 'submit_question' ) );
		add_action( 'wp_ajax_nopriv_wpam_submit_question', array( $this, 'submit_question' ) );
		add_action( 'wp_ajax_wpam_get_messages', array( $this, 'get_messages' ) );
		add_action( 'wp_ajax_nopriv_wpam_get_messages', array( $this, 'get_messages' ) );
	}
	...
	public function submit_question() {
		...
		wp_send_json_success( array( 'message' => __( 'Message submitted for review.', 'wpam' ) ) );
	}
