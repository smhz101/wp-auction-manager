/**
 * Dynamically builds and highlights a submenu in the WordPress admin menu
 * for the custom Auctions section based on the provided path.
 *
 * @param {string} path - The current submenu path to highlight (e.g. "/bids").
 */
