...
function DropdownMenuCheckboxItem({
  ...
  return (
    (<DropdownMenuPrimitive.CheckboxItem
      ...
      {...props}>
      <span
        className="tw-pointer-events-none tw-absolute tw-left-2 tw-flex tw-size-3.5 tw-items-center tw-justify-center">
...
function DropdownMenuLabel({
  ...
  return (
    (<DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn("tw-px-2 tw-py-1.5 tw-text-sm tw-font-medium data-[inset]:tw-pl-8", className)}
      {...props} />)
  );
}
